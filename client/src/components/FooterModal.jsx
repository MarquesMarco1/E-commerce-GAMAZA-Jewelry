        ...
        <div className="bg-white rounded-lg border border-gray-300 w-11/12 md:w-3/4 lg:w-1/2 flex shadow-lg relative overflow-hidden">
            ...
            <div className="w-2/3 p-6 bg-white space-y-6">
                ...
                <div>
                    ...
                    <FaCreditCard size={48} color="#2d3748" /> {/* Icone carte de crédit */}
                    <FaCcVisa size={48} color="#1a1f71" /> {/* Icone Visa */}
                    <FaCcMastercard size={48} color="#ff5f00" /> {/* Icone MasterCard */}
                    <FaPaypal size={48} color="#0070ba" /> {/* Icone PayPal */}
                    </div>
                </div>
                )}
                ...
                <div>
                    ...
                    Web@cademie by Epitech projet e-commerce GAMAZA -> Guillaume,
                    Aymeric, Marco, Alice, Zoé, Ambroise.
                    </p>
                    <p className="text-gray-600 mt-4">
                    Nous avons créé notre boutique de bijoux en ligne afin de
                    sublimer les femmes avec des bijoux raffinés et de qualité.
                    </p>
                </div>
                )}
                ...
                <div>
                    ...
                    <p className="text-gray-600">
                    Vous pouvez retourner vos produits dans un délai de 30 jours
                    après réception. Assurez-vous que les produits soient dans
                    leur état d'origine.
                    </p>
                </div>
                )}
                ...
                <div>
                    ...
                    <p className="text-gray-600">
                    Utilisez notre outil en ligne pour suivre l'état de votre
                    commande. Vous aurez besoin de votre numéro de commande pour
                ...
                <div>
                    ...
                    <p className="text-gray-600">
                    Découvrez les conditions générales régissant vos achats sur
                    notre site.
                    </p>
                </div>
                )}
