  ...
  return (
    <div className="space-y-4 flex flex-col items-start justify-center m-24">
      ...
      <div className="relative items-center w-full overflow-hidden">
        <button
          className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full hover:bg-opacity-75 transition duration-300"
        ...
        <div className="flex items-center w-10/12 transition-transform duration-500 ease-in-out mx-auto">
          {displayCarousel && (
            <>
              ...
              <a
                href={`/product/${activeImages[1].id}`}
                className="z-10"
              ...
              >
                <img
                  className="border-grey border-4 rounded-2xl shadow-lg"
