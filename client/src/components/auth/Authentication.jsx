    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="relative w-4/5 bg-white shadow-lg rounded-lg">
          <div
            className={`absolute inset-0 flex transform transition-transform duration-500 ${isSignUp ? "-translate-x-full" : "translate-x-0"
              }`}
          >
          ...
          <div
            className={`absolute inset-0 flex transform transition-transform duration-500 ${isSignUp ? "translate-x-0" : "translate-x-full"
              }`}
          >
